		...
		<div class="content-blog content-account">
			...
			<div class="row">
				<div class="col-md-6">
					...
					<?php
						$csql = "SELECT u1.firstname, u1.lastname, u1.address1, u1.address2, u1.city, u1.plcstation, u1.country,
				u1.zip, u.mobile1, u1.mobile2, u1.email FROM users u JOIN usersmeta u1 WHERE u.id=u1.uid AND u.id=$uid";
